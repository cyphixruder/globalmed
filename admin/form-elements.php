...
<!-- Mirrored from jaybabani.com/ultra-admin-html/form-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Sep 2015 13:01:18 GMT -->
<head>
    ...
    <body class=" ">
            ...
            <section id="main-content" class=" ">
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Basic Profile</h2>
                    ...
                    <div class="col-lg-5 col-md-5 col-xs-12 col-sm-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Profile Display</h2>
                                <div class="actions panel_actions pull-right">
                                    <i class="box_toggle fa fa-chevron-down"></i>
                                    <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                                    <i class="box_close fa fa-times"></i>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <center>
                                            ...
                                            <div class="container-display">
                                                <img src="assets/images/pro.jpg" onclick="triggerClick()" id="profileDisplay">
        ...
        <!-- START Profile Display -->
        <script src="assets/js/profiledisplay.js" type="text/javascript"></script>
        <!-- STOP Profile Display -->
